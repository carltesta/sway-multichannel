...
<>available_processing, <>all_processing, <>global_change=false, <>quadrant_change=true;
	...
	//Right now when I want to add new types of processing I need to create a new method within this class file. How could I set this up so that I can add new processing types externally?
	...
	reset {
		...
		quadrant_names.put(2,\reverb);
		quadrant_names.put(3,\pitchbend);
